...
namespace model_MCMC_NSS_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 34, column 2 to column 48)",
                                                      ...
                                                      " (in 'string', line 99, column 8 to column 56)",
                                                      " (in 'string', line 100, column 8 to column 35)",
                                                      " (in 'string', line 98, column 11 to line 101, column 7)",
                                                      " (in 'string', line 94, column 8 to column 52)",
                                                      " (in 'string', line 96, column 8 to column 35)",
                                                      " (in 'string', line 93, column 20 to line 98, column 7)",
                                                      " (in 'string', line 93, column 6 to line 101, column 7)",
                                                      " (in 'string', line 92, column 21 to line 102, column 5)",
                                                      " (in 'string', line 92, column 4 to line 102, column 5)",
                                                      " (in 'string', line 107, column 8 to column 49)",
                                                      " (in 'string', line 106, column 11 to line 108, column 7)",
                                                      " (in 'string', line 105, column 8 to column 50)",
                                                      " (in 'string', line 104, column 20 to line 106, column 7)",
                                                      " (in 'string', line 104, column 6 to line 108, column 7)",
                                                      " (in 'string', line 103, column 21 to line 109, column 5)",
                                                      " (in 'string', line 103, column 4 to line 109, column 5)",
                                                      " (in 'string', line 91, column 18 to line 110, column 3)",
                                                      " (in 'string', line 91, column 2 to line 110, column 3)",
                                                      ...
                                                      " (in 'string', line 20, column 38 to column 41)",
                                                      " (in 'string', line 20, column 18 to column 22)",
                                                      " (in 'string', line 21, column 28 to column 31)",
                                                      " (in 'string', line 21, column 9 to column 13)",
                                                      " (in 'string', line 22, column 20 to column 22)",
                                                      " (in 'string', line 22, column 9 to column 12)",
                                                      " (in 'string', line 23, column 13 to column 16)",
                                                      " (in 'string', line 24, column 23 to column 26)",
                                                      " (in 'string', line 25, column 12 to column 14)",
                                                      " (in 'string', line 25, column 16 to column 19)",
                                                      " (in 'string', line 25, column 21 to column 25)",
                                                      " (in 'string', line 27, column 18 to column 21)",
                                                      " (in 'string', line 28, column 9 to column 12)",
                                                      " (in 'string', line 29, column 22 to column 24)",
                                                      " (in 'string', line 29, column 9 to column 12)",
                                                      " (in 'string', line 30, column 18 to column 21)",
                                                      " (in 'string', line 34, column 33 to column 35)",
                                                      " (in 'string', line 34, column 37 to column 40)",
                                                      " (in 'string', line 34, column 42 to column 46)",
                                                      " (in 'string', line 35, column 23 to column 25)",
                                                      " (in 'string', line 35, column 27 to column 30)",
                                                      " (in 'string', line 35, column 32 to column 36)",
                                                      " (in 'string', line 36, column 28 to column 31)",
                                                      " (in 'string', line 36, column 9 to column 13)",
                                                      " (in 'string', line 37, column 31 to column 33)",
                                                      " (in 'string', line 37, column 18 to column 21)",
                                                      " (in 'string', line 38, column 21 to column 23)",
                                                      " (in 'string', line 38, column 9 to column 12)",
                                                      " (in 'string', line 88, column 17 to column 19)",
                                                      " (in 'string', line 88, column 9 to column 12)",
                                                      " (in 'string', line 89, column 24 to column 26)",
                                                      " (in 'string', line 89, column 9 to column 14)",
                                                      " (in 'string', line 90, column 21 to column 23)",
                                                      " (in 'string', line 90, column 9 to column 12)"};
#include <stan_meta_header.hpp>
class model_MCMC_NSS final : public model_base_crtp<model_MCMC_NSS> {
private:
  int NE;
  int NF;
  std::vector<int> TP;
...
public:
  ...
  inline std::string model_name() const final { return "model_MCMC_NSS"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_MCMC_NSS(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_MCMC_NSS_namespace::model_MCMC_NSS";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_MCMC_NSS_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_MCMC_NSS_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_MCMC_NSS_namespace::model_MCMC_NSS;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_MCMC_NSS_namespace::profiles__;
}
#endif
#endif
