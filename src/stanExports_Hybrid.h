...
namespace model_Hybrid_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 80, column 3 to column 35)",
                                                      " (in 'string', line 81, column 3 to column 32)",
                                                      " (in 'string', line 87, column 8 to column 54)",
                                                      ...
                                                      " (in 'string', line 83, column 20 to line 91, column 4)",
                                                      " (in 'string', line 83, column 3 to line 91, column 4)",
                                                      " (in 'string', line 93, column 5 to column 44)",
                                                      " (in 'string', line 92, column 20 to line 94, column 4)",
                                                      " (in 'string', line 92, column 3 to line 94, column 4)",
                                                      " (in 'string', line 82, column 17 to line 95, column 2)",
                                                      " (in 'string', line 82, column 1 to line 95, column 2)",
                                                      ...
                                                      " (in 'string', line 10, column 8 to column 11)",
                                                      ...
                                                      " (in 'string', line 13, column 12 to column 15)",
                                                      " (in 'string', line 13, column 2 to column 32)",
                                                      " (in 'string', line 14, column 2 to column 34)",
                                                      " (in 'string', line 17, column 8 to column 10)",
                                                      " (in 'string', line 17, column 19 to column 22)",
                                                      " (in 'string', line 18, column 9 to column 12)",
                                                      " (in 'string', line 19, column 9 to column 12)",
                                                      " (in 'string', line 22, column 8 to column 10)",
                                                      " (in 'string', line 22, column 12 to column 15)",
                                                      " (in 'string', line 22, column 17 to column 21)",
                                                      ...
                                                      " (in 'string', line 26, column 19 to column 22)",
                                                      " (in 'string', line 30, column 8 to column 10)",
                                                      " (in 'string', line 30, column 12 to column 15)",
                                                      " (in 'string', line 30, column 17 to column 21)",
                                                      " (in 'string', line 32, column 18 to column 21)",
                                                      " (in 'string', line 33, column 8 to column 10)",
                                                      " (in 'string', line 33, column 28 to column 31)",
                                                      " (in 'string', line 79, column 9 to column 11)",
                                                      " (in 'string', line 79, column 20 to column 23)",
                                                      " (in 'string', line 80, column 9 to column 11)",
                                                      " (in 'string', line 80, column 20 to column 25)",
                                                      " (in 'string', line 81, column 9 to column 11)",
                                                      " (in 'string', line 81, column 20 to column 23)"};
#include <stan_meta_header.hpp>
class model_Hybrid final : public model_base_crtp<model_Hybrid> {
private:
  int NE;
  int NF;
  std::vector<int> MT;
...
public:
  ...
  inline std::string model_name() const final { return "model_Hybrid"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_Hybrid(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_Hybrid_namespace::model_Hybrid";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_Hybrid_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_Hybrid_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_Hybrid_namespace::model_Hybrid;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_Hybrid_namespace::profiles__;
}
#endif
#endif
