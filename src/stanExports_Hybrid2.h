...
namespace model_Hybrid2_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 86, column 8 to column 54)",
                                                      ...
                                                      " (in 'string', line 82, column 20 to line 88, column 4)",
                                                      " (in 'string', line 82, column 3 to line 88, column 4)",
                                                      " (in 'string', line 90, column 5 to column 44)",
                                                      " (in 'string', line 89, column 20 to line 91, column 4)",
                                                      " (in 'string', line 89, column 3 to line 91, column 4)",
                                                      " (in 'string', line 81, column 17 to line 92, column 2)",
                                                      " (in 'string', line 81, column 1 to line 92, column 2)",
...
class model_Hybrid2 final : public model_base_crtp<model_Hybrid2> {
private:
  int NE;
  int NF;
  std::vector<int> MT;
...
public:
  ...
  inline std::string model_name() const final { return "model_Hybrid2"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = %%NAME%%3 %%VERSION%%", "stancflags = "};
  }
  
  
  model_Hybrid2(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_Hybrid2_namespace::model_Hybrid2";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_Hybrid2_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_Hybrid2_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_Hybrid2_namespace::model_Hybrid2;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_Hybrid2_namespace::profiles__;
}
#endif
#endif
